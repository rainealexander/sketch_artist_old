...
enum Difficulty { hard = 5, medium = 7, easy = 9, };

//Functions - Raine Adams
int faceRand();
...
void intro(int random) {
	...
	if (random == 0) {
		...
		wcout << L"“Hello, my name is Jenelle with channel seven news. Could you describe the man that saved your life?”\n";
